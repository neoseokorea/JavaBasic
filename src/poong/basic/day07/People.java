...
import poong.basic.day01.Student;
...
public class People {
    public static void main(String[] args) {
        /*
            ...
            객체의 기능을 나타내는 매서드로 구성

            클래스는 객체의 설계도이기 때문에
            실제 정보를 저장할 수 없음.
            실제 정보를 저장하려면, 이것의 객체화가 필요한데
            객체를 선언하는 과정을 <객체화>라고 함.
            객체화를 통해 나온 결과물을 객체/인스턴스라고 하는데
    ...
    static class Person {
        ...
        //생성자 : 변수 초기화 관련 트수한 메서즈
        //public 클래스명(매개변수);


        // 생성자의 매개변수명과 멤버변수명이 일치하려면
        // 일반적으로 쉐도잉 현상이 발생
