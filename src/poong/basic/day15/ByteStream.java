...
public class ByteStream {
    public static void main(String[] args) {
        ...
        /*
            ...
            주로 바이너리 기반 데이터(이미지, 동영상 등)을 처리할 때 사용
        ...
        //파일에 쓰기 2
        String fpath = "c:/Java/info2.txt"; //저장위치&파일명
        ...
        //파일에 쓰기 3
        String fpath2 = "c:/Java/info3.txt"; //저장위치&파일명
...
//            String result = "";
            ...
            //InputStreamReader 덕택에 한글은 제대로 출력됨.
        ...
        try {
            fis = new FileInputStream(fpath);
            bis = new BufferedInputStream(fis); //기본버퍼크기는 512
