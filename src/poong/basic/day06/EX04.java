...
//        if (total >= 10) noteCase = 2;
//        if (total >= 50) noteCase = 3;
//        if (total >= 100) noteCase = 3;
//        if (total >= 500) noteCase = 4;
//        if (total >= 1000) noteCase = 5;
//        if (total >= 5000) noteCase = 6;
//        if (total >= 10000) noteCase = 7;
//        if (total >= 50000) noteCase = 8;
//        if (total >= 10) noteCase = 9;
//        else noteCase = 1;
//
//
//
